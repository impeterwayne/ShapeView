...
/**
 * TextView's Shape attribute values
 */
public final class ShapeTextViewStyleable implements IShapeDrawableStyleable, ITextColorStyleable {
    ...
    private static final int[][] EFFECT_STYLEABLES = {
        {
            R.styleable.ShapeTextView_shape_effect1Type,
            R.styleable.ShapeTextView_shape_effect1Color,
            R.styleable.ShapeTextView_shape_effect1Blur,
            R.styleable.ShapeTextView_shape_effect1Spread,
            R.styleable.ShapeTextView_shape_effect1OffsetX,
            R.styleable.ShapeTextView_shape_effect1OffsetY,
            R.styleable.ShapeTextView_shape_effect1Edges,
        },
        {
            R.styleable.ShapeTextView_shape_effect2Type,
            R.styleable.ShapeTextView_shape_effect2Color,
            R.styleable.ShapeTextView_shape_effect2Blur,
            R.styleable.ShapeTextView_shape_effect2Spread,
            R.styleable.ShapeTextView_shape_effect2OffsetX,
            R.styleable.ShapeTextView_shape_effect2OffsetY,
            R.styleable.ShapeTextView_shape_effect2Edges,
        },
        {
            R.styleable.ShapeTextView_shape_effect3Type,
            R.styleable.ShapeTextView_shape_effect3Color,
            R.styleable.ShapeTextView_shape_effect3Blur,
            R.styleable.ShapeTextView_shape_effect3Spread,
            R.styleable.ShapeTextView_shape_effect3OffsetX,
            R.styleable.ShapeTextView_shape_effect3OffsetY,
            R.styleable.ShapeTextView_shape_effect3Edges,
        },
        {
            R.styleable.ShapeTextView_shape_effect4Type,
            R.styleable.ShapeTextView_shape_effect4Color,
            R.styleable.ShapeTextView_shape_effect4Blur,
            R.styleable.ShapeTextView_shape_effect4Spread,
            R.styleable.ShapeTextView_shape_effect4OffsetX,
            R.styleable.ShapeTextView_shape_effect4OffsetY,
            R.styleable.ShapeTextView_shape_effect4Edges,
        },
    };
    ...
    public int getSolidGradientRadiusSizeStyleable() {
        return R.styleable.ShapeTextView_shape_solidGradientRadiusSize;
    }

    @Override
    public int getSolidGradientRadiusRatioStyleable() {
        return R.styleable.ShapeTextView_shape_solidGradientRadiusRatio;
    }

    @Override
    public int getSolidGradientRadiusXStyleable() {
        return R.styleable.ShapeTextView_shape_solidGradientRadiusX;
    }

    @Override
    public int getSolidGradientRadiusYStyleable() {
        return R.styleable.ShapeTextView_shape_solidGradientRadiusY;
    }

    @Override
    public int getSolidRadialAngleStyleable() {
        return R.styleable.ShapeTextView_shape_solidRadialAngle;
    }

    @Override
    public int getSolidGradientStartPercentStyleable() {
        return R.styleable.ShapeTextView_shape_solidGradientStartPercent;
    }

    @Override
    public int getSolidGradientCenterPercentStyleable() {
        return R.styleable.ShapeTextView_shape_solidGradientCenterPercent;
    }

    @Override
    public int getSolidGradientEndPercentStyleable() {
        return R.styleable.ShapeTextView_shape_solidGradientEndPercent;
    }

    @Override
    public int getSolidGradientStartXStyleable() {
        return R.styleable.ShapeTextView_shape_solidGradientStartX;
    }

    @Override
    public int getSolidGradientStartYStyleable() {
        return R.styleable.ShapeTextView_shape_solidGradientStartY;
    }

    @Override
    public int getSolidGradientEndXStyleable() {
        return R.styleable.ShapeTextView_shape_solidGradientEndX;
    }

    @Override
    public int getSolidGradientEndYStyleable() {
        return R.styleable.ShapeTextView_shape_solidGradientEndY;
    }
    ...
    public int getStrokeGradientTypeStyleable() {
        return R.styleable.ShapeTextView_shape_strokeGradientType;
    }

    @Override
    public int getStrokeGradientCenterXStyleable() {
        return R.styleable.ShapeTextView_shape_strokeGradientCenterX;
    }

    @Override
    public int getStrokeGradientCenterYStyleable() {
        return R.styleable.ShapeTextView_shape_strokeGradientCenterY;
    }

    @Override
    public int getStrokeGradientRadiusSizeStyleable() {
        return R.styleable.ShapeTextView_shape_strokeGradientRadiusSize;
    }

    @Override
    public int getStrokeGradientRadiusRatioStyleable() {
        return R.styleable.ShapeTextView_shape_strokeGradientRadiusRatio;
    }

    @Override
    public int getStrokeGradientRadiusXStyleable() {
        return R.styleable.ShapeTextView_shape_strokeGradientRadiusX;
    }

    @Override
    public int getStrokeGradientRadiusYStyleable() {
        return R.styleable.ShapeTextView_shape_strokeGradientRadiusY;
    }

    @Override
    public int getStrokeRadialAngleStyleable() {
        return R.styleable.ShapeTextView_shape_strokeRadialAngle;
    }

    @Override
    public int getStrokeGradientStartPercentStyleable() {
        return R.styleable.ShapeTextView_shape_strokeGradientStartPercent;
    }

    @Override
    public int getStrokeGradientCenterPercentStyleable() {
        return R.styleable.ShapeTextView_shape_strokeGradientCenterPercent;
    }

    @Override
    public int getStrokeGradientEndPercentStyleable() {
        return R.styleable.ShapeTextView_shape_strokeGradientEndPercent;
    }

    @Override
    public int getStrokeGradientStartXStyleable() {
        return R.styleable.ShapeTextView_shape_strokeGradientStartX;
    }

    @Override
    public int getStrokeGradientStartYStyleable() {
        return R.styleable.ShapeTextView_shape_strokeGradientStartY;
    }

    @Override
    public int getStrokeGradientEndXStyleable() {
        return R.styleable.ShapeTextView_shape_strokeGradientEndX;
    }

    @Override
    public int getStrokeGradientEndYStyleable() {
        return R.styleable.ShapeTextView_shape_strokeGradientEndY;
    }
    ...
    public int getEffectPadContentStyleable() {
        return R.styleable.ShapeTextView_shape_effectPadContent;
    }
