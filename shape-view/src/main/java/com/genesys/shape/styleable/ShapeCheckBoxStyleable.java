...
/**
 * CheckBox's Shape attribute values
 */
public final class ShapeCheckBoxStyleable implements IShapeDrawableStyleable,
    ...
    private static final int[][] EFFECT_STYLEABLES = {
        {
            R.styleable.ShapeCheckBox_shape_effect1Type,
            R.styleable.ShapeCheckBox_shape_effect1Color,
            R.styleable.ShapeCheckBox_shape_effect1Blur,
            R.styleable.ShapeCheckBox_shape_effect1Spread,
            R.styleable.ShapeCheckBox_shape_effect1OffsetX,
            R.styleable.ShapeCheckBox_shape_effect1OffsetY,
            R.styleable.ShapeCheckBox_shape_effect1Edges,
        },
        {
            R.styleable.ShapeCheckBox_shape_effect2Type,
            R.styleable.ShapeCheckBox_shape_effect2Color,
            R.styleable.ShapeCheckBox_shape_effect2Blur,
            R.styleable.ShapeCheckBox_shape_effect2Spread,
            R.styleable.ShapeCheckBox_shape_effect2OffsetX,
            R.styleable.ShapeCheckBox_shape_effect2OffsetY,
            R.styleable.ShapeCheckBox_shape_effect2Edges,
        },
        {
            R.styleable.ShapeCheckBox_shape_effect3Type,
            R.styleable.ShapeCheckBox_shape_effect3Color,
            R.styleable.ShapeCheckBox_shape_effect3Blur,
            R.styleable.ShapeCheckBox_shape_effect3Spread,
            R.styleable.ShapeCheckBox_shape_effect3OffsetX,
            R.styleable.ShapeCheckBox_shape_effect3OffsetY,
            R.styleable.ShapeCheckBox_shape_effect3Edges,
        },
        {
            R.styleable.ShapeCheckBox_shape_effect4Type,
            R.styleable.ShapeCheckBox_shape_effect4Color,
            R.styleable.ShapeCheckBox_shape_effect4Blur,
            R.styleable.ShapeCheckBox_shape_effect4Spread,
            R.styleable.ShapeCheckBox_shape_effect4OffsetX,
            R.styleable.ShapeCheckBox_shape_effect4OffsetY,
            R.styleable.ShapeCheckBox_shape_effect4Edges,
        },
    };
    ...
    public int getSolidGradientRadiusSizeStyleable() {
        return R.styleable.ShapeCheckBox_shape_solidGradientRadiusSize;
    }

    @Override
    public int getSolidGradientRadiusRatioStyleable() {
        return R.styleable.ShapeCheckBox_shape_solidGradientRadiusRatio;
    }

    @Override
    public int getSolidGradientRadiusXStyleable() {
        return R.styleable.ShapeCheckBox_shape_solidGradientRadiusX;
    }

    @Override
    public int getSolidGradientRadiusYStyleable() {
        return R.styleable.ShapeCheckBox_shape_solidGradientRadiusY;
    }

    @Override
    public int getSolidRadialAngleStyleable() {
        return R.styleable.ShapeCheckBox_shape_solidRadialAngle;
    }

    @Override
    public int getSolidGradientStartPercentStyleable() {
        return R.styleable.ShapeCheckBox_shape_solidGradientStartPercent;
    }

    @Override
    public int getSolidGradientCenterPercentStyleable() {
        return R.styleable.ShapeCheckBox_shape_solidGradientCenterPercent;
    }

    @Override
    public int getSolidGradientEndPercentStyleable() {
        return R.styleable.ShapeCheckBox_shape_solidGradientEndPercent;
    }

    @Override
    public int getSolidGradientStartXStyleable() {
        return R.styleable.ShapeCheckBox_shape_solidGradientStartX;
    }

    @Override
    public int getSolidGradientStartYStyleable() {
        return R.styleable.ShapeCheckBox_shape_solidGradientStartY;
    }

    @Override
    public int getSolidGradientEndXStyleable() {
        return R.styleable.ShapeCheckBox_shape_solidGradientEndX;
    }

    @Override
    public int getSolidGradientEndYStyleable() {
        return R.styleable.ShapeCheckBox_shape_solidGradientEndY;
    }
    ...
    public int getStrokeGradientTypeStyleable() {
        return R.styleable.ShapeCheckBox_shape_strokeGradientType;
    }

    @Override
    public int getStrokeGradientCenterXStyleable() {
        return R.styleable.ShapeCheckBox_shape_strokeGradientCenterX;
    }

    @Override
    public int getStrokeGradientCenterYStyleable() {
        return R.styleable.ShapeCheckBox_shape_strokeGradientCenterY;
    }

    @Override
    public int getStrokeGradientRadiusSizeStyleable() {
        return R.styleable.ShapeCheckBox_shape_strokeGradientRadiusSize;
    }

    @Override
    public int getStrokeGradientRadiusRatioStyleable() {
        return R.styleable.ShapeCheckBox_shape_strokeGradientRadiusRatio;
    }

    @Override
    public int getStrokeGradientRadiusXStyleable() {
        return R.styleable.ShapeCheckBox_shape_strokeGradientRadiusX;
    }

    @Override
    public int getStrokeGradientRadiusYStyleable() {
        return R.styleable.ShapeCheckBox_shape_strokeGradientRadiusY;
    }

    @Override
    public int getStrokeRadialAngleStyleable() {
        return R.styleable.ShapeCheckBox_shape_strokeRadialAngle;
    }

    @Override
    public int getStrokeGradientStartPercentStyleable() {
        return R.styleable.ShapeCheckBox_shape_strokeGradientStartPercent;
    }

    @Override
    public int getStrokeGradientCenterPercentStyleable() {
        return R.styleable.ShapeCheckBox_shape_strokeGradientCenterPercent;
    }

    @Override
    public int getStrokeGradientEndPercentStyleable() {
        return R.styleable.ShapeCheckBox_shape_strokeGradientEndPercent;
    }

    @Override
    public int getStrokeGradientStartXStyleable() {
        return R.styleable.ShapeCheckBox_shape_strokeGradientStartX;
    }

    @Override
    public int getStrokeGradientStartYStyleable() {
        return R.styleable.ShapeCheckBox_shape_strokeGradientStartY;
    }

    @Override
    public int getStrokeGradientEndXStyleable() {
        return R.styleable.ShapeCheckBox_shape_strokeGradientEndX;
    }

    @Override
    public int getStrokeGradientEndYStyleable() {
        return R.styleable.ShapeCheckBox_shape_strokeGradientEndY;
    }
    ...
    public int getEffectPadContentStyleable() {
        return R.styleable.ShapeCheckBox_shape_effectPadContent;
    }
